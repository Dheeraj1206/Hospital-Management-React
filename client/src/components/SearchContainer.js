...
import styles from '../styles/SearchContainer.module.css'; // Importing the CSS module
...
const SearchContainer = () => {
    ...
    return (
        <div className={styles['search-container']}> {/* Apply styles from the CSS module */}
            <h2>Find a Doctor</h2>
            <p>Search doctors by specialty, condition, or doctor's name</p>
            <div className={styles['search-box']}> {/* Apply styles from the CSS module */}
                ...
                <div>
                    ...
                    />
                    <div className={styles['suggestion-box']}> {/* Apply styles from the CSS module */}
                        {specialtyQuery &&
                        specialtySuggestions.length > 0 &&
                        !specialtyFound ? (
                            <ul className={styles['suggestions-list']}> {/* Apply styles from the CSS module */}
            ...
            {error && <p className={styles['error-message']}>{error}</p>} {/* Apply styles from the CSS module */}
        </div>
    );
};
